...
const TRANSLATIONS = {
  en: {
    ...
    dramsLogged: 'Drams logged',
    lastDramLogged: 'Last dram',
    logAnotherDram: 'Log another dram',
    logAnotherDramShort: 'Dram',
    saveDram: 'Save dram',
    dramDate: 'Dram date',
    dramNotes: 'Dram notes',
    dramNotesPlaceholder: 'Optional notes from this tasting…',
    dramHistory: 'Dram history',
    noDramsYet: 'No drams logged yet',
    ...
    photoSourceSubtitle: 'Choose where to get the image from.',
    photoLibraryCopy: 'Open your photo library',
    nativeCameraCopy: 'Use the native camera',
    photoUploadHint: 'Click to add a photo · Max 600px · JPEG compressed',
    photoCompressed: (kb) => `~${kb} KB after compression`,
    currentPhoto: 'Current photo',
    removePhoto: 'Remove photo',
    cameraCapturePhotoSubtitle: 'Use your device camera to capture a photo.',
    cameraBottleSubtitle: 'Use your device camera to capture the bottle label.',
    cameraCloseAria: 'Close camera',
    cameraOpening: 'Opening camera…',
    cameraCapture: 'Capture',
    cameraUsePicker: 'Use device picker',
    cameraNotSupported: 'Camera access is not supported in this browser.',
    cameraUnavailable: 'Camera access was blocked or unavailable on this device.',
    cameraProcessFailed: 'Could not process the camera image.',
    cameraCaptureFailed: 'Could not capture the camera image.',
    cameraPickerFallback: 'Camera access was unavailable, so we opened the device picker instead.',
    ...
    dramLogged: (name) => `${name} — another dram logged!`,
    ...
    feedLogged: 'logged',
    feedDramLogged: 'logged another dram',
    feedRated: 'rated',
    feedWishlisted: 'wishlisted',
  ...
  es: {
    ...
    dramsLogged: 'Drams registrados',
    lastDramLogged: 'Último dram',
    logAnotherDram: 'Registrar otro dram',
    logAnotherDramShort: 'Dram',
    saveDram: 'Guardar dram',
    dramDate: 'Fecha del dram',
    dramNotes: 'Notas del dram',
    dramNotesPlaceholder: 'Notas opcionales de esta cata…',
    dramHistory: 'Historial de drams',
    noDramsYet: 'Aún no se han registrado drams',
    ...
    choosePhotoSource: 'Elegir origen de la foto',
    photoSourceSubtitle: 'Elige de dónde obtener la imagen.',
    photoLibraryCopy: 'Abrir tu biblioteca de fotos',
    nativeCameraCopy: 'Usar la cámara del dispositivo',
    photoUploadHint: 'Pulsa para añadir una foto · Máx 600px · JPEG comprimido',
    photoCompressed: (kb) => `~${kb} KB tras la compresión`,
    currentPhoto: 'Foto actual',
    removePhoto: 'Eliminar foto',
    cameraCapturePhotoSubtitle: 'Usa la cámara del dispositivo para hacer una foto.',
    cameraBottleSubtitle: 'Usa la cámara del dispositivo para fotografiar la etiqueta de la botella.',
    cameraCloseAria: 'Cerrar cámara',
    cameraOpening: 'Abriendo cámara…',
    cameraCapture: 'Capturar',
    cameraUsePicker: 'Usar selector del dispositivo',
    cameraNotSupported: 'El acceso a la cámara no es compatible con este navegador.',
    cameraUnavailable: 'El acceso a la cámara fue bloqueado o no está disponible en este dispositivo.',
    cameraProcessFailed: 'No se pudo procesar la imagen de la cámara.',
    cameraCaptureFailed: 'No se pudo capturar la imagen de la cámara.',
    cameraPickerFallback: 'No había acceso a la cámara, así que abrimos el selector del dispositivo.',
    ...
    dramLogged: (name) => `${name} — ¡otro dram registrado!`,
    ...
    feedLogged: 'añadió',
    feedDramLogged: 'registró otro dram',
    feedRated: 'valoró',
    feedWishlisted: 'quiere probar',
