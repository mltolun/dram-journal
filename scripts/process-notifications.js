...
const STRINGS = {
  en: {
    ...
    followReqBody:     (name) => `<span style="font-family:'JetBrains Mono',monospace;font-size:11px;color:${AMBER_LIGHT};">${name}</span>&nbsp;has sent you a follow request. If you accept, they'll receive a weekly digest of the whiskies you add, rate, and log as drams.`,
    followReqCta:      'Review request →',
    followReqSubject:  'Someone wants to follow your Dram Journal',
    followReqTxtHdr:   'New follow request',
    followReqTxtBody:  (name) => `${name} wants to follow your whisky journal.\n\nIf you accept, they'll receive a weekly digest of the whiskies you add, rate, and log as drams.`,
    ...
    followAccBody:     (name) => `<span style="font-family:'JetBrains Mono',monospace;font-size:11px;color:${AMBER_LIGHT};">${name}</span>&nbsp;accepted your follow request. You'll now receive their whisky additions, ratings, and dram logs in your weekly Monday update.`,
    ...
    followAccTxtBody:  (name) => `${name} accepted your follow request.\n\nYou'll now receive their whisky additions, ratings, and dram logs in your weekly Monday update.`,
  ...
  es: {
    ...
    followReqBody:     (name) => `<span style="font-family:'JetBrains Mono',monospace;font-size:11px;color:${AMBER_LIGHT};">${name}</span>&nbsp;te ha enviado una solicitud de seguimiento. Si la aceptas, recibirá un resumen semanal de los whiskies que añadas, valores y registres como drams.`,
    ...
    followReqTxtBody:  (name) => `${name} quiere seguir tu diario de whiskies.\n\nSi aceptas, recibirá un resumen semanal de los whiskies que añadas, valores y registres como drams.`,
    ...
    followAccBody:     (name) => `<span style="font-family:'JetBrains Mono',monospace;font-size:11px;color:${AMBER_LIGHT};">${name}</span>&nbsp;aceptó tu solicitud de seguimiento. Ahora recibirás sus adiciones, valoraciones y registros de drams en tu actualización semanal de los lunes.`,
    ...
    followAccTxtBody:  (name) => `${name} aceptó tu solicitud de seguimiento.\n\nAhora recibirás sus adiciones, valoraciones y registros de drams en tu actualización semanal de los lunes.`,
